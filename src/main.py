...
def create_system():
    ...
    for center in centers_data:
        id = center["id"] + "@localhost"
        centers_dict[id] = {"type": "CENTER", "id": id, "lat": center["lat"], "lon": center["lon"]}
...
if __name__ == "__main__":
    ...
    # p3 = multiprocessing.Process(target=create_gui, args=(
    # len(drones), proxy, values, [center.position for center in centers], [base.position for base in support_bases]))
